...
from nextsync.util.paths import ensure_private_directory, state_dir
...
class AppLogger:
    ...
    def __init__(
        ...
        *,
        ...
        self.prefix = path.stem if path else "nextsync"
        self.retention_days = retention_days
        ...
        self.logger = logging.getLogger(f"nextsync.{id(self)}")
