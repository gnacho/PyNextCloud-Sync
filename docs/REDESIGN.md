...
account against `hub.domatix.com` consumed 11 GB of staging across
...
`hub.domatix.com` runs openresty and sends the header `Upgrade: h2,h2c`
...
When the bootstrap did kick off against `hub.domatix.com`, it ran for
