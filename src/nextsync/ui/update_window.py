...
from nextsync import APP_NAME, VERSION
from nextsync.core.updates import RELEASES_URL, UpdateManifest
    ...
    def __init__(
        ...
        *,
        ...
        explanation = Gtk.Label(
            label=(
                _(
                    "This update is mandatory. NextSync will not start "
                    "synchronization or allow use of the current version."
                )
                if mandatory
                else _(
                    "This update is optional. NextSync can continue running "
