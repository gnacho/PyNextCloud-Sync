...
from nextsync.util.paths import (
    desktop_dir,
    gtk_bookmarks_path,
    project_root,
    user_data_dir,
...
FOLDER_ICON_NAME = "io.github.gnacho.nextsync-folder"
...
class DesktopIntegration:
    ...
    def _write_bookmarks(self, lines: list[str]) -> None:
        ...
        temporary = self.bookmarks.with_name(f".{self.bookmarks.name}.nextsync.tmp")
        payload = "\n".join(lines)
        if payload:
            payload += "\n"
