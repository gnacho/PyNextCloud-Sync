...
from nextsync import APP_ID
from nextsync.core.account_manager import AccountManager
from nextsync.core.desktop_integration import DesktopIntegration
from nextsync.core.legacy_cleanup import cleanup_legacy_bootstrap
...
from nextsync.nextcloud.credentials import CredentialStore
from nextsync.nextcloud.api import NextcloudApi
from nextsync.storage.config import ConfigStore, ConfigurationError
from nextsync.storage.log import AppLogger
from nextsync.ui.main_window import MainWindow
from nextsync.ui.conflict_resolver import ConflictResolverWindow
from nextsync.ui.settings import SettingsWindow
from nextsync.ui.setup import SetupWindow
from nextsync.ui.tray import StatusNotifier
from nextsync.ui.update_window import UpdateWindow
from nextsync.util.i18n import _
from nextsync.util.paths import project_root


class NextSyncApplication(Adw.Application):
    ...
    def _notify_sync_failure(self, account_name: str, result: object) -> None:
        if getattr(result, "classification", "") == "authentication":
            ...
            notification.set_body(
                _("{account}: open NextSync to check the account credential.").format(
    ...
    def request_quit(self) -> None:
        if self._any_engine_running():
            ...
            notification.set_body(
                _("NextSync will quit when the current synchronization finishes.")
            )
